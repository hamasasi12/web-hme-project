...
<body>
    ...
    <header id="header" class="fixed-top ">
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo me-auto"><a href="index.html">HME Jaya!</a></h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1"
                    ...
                    <h1>Selamat Datang di Website Resmi Himpunan Mahasiswa Elektro Poliban</h1>
                ...
                <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
                    <img src="assets/img/Mainfoto2.png" class="img-fluid animated" alt="">
                </div>
            </div>
        </div>
    ...
    <main id="main">
        ...
        <section id="clients" class="clients section-bg">
            <div class="container">
                ...
                <div class="row" data-aos="zoom-in">
                    ...
                    <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                        <img src="assets/img/clients/poliban.png" class="img-fluid" alt="">
                    </div>
        ...
        <section id="about" class="about">
            <div class="container" data-aos="fade-up">
              ...
              Assalamualaikum Wr. Wb.
                        ...
                        <p>
                            Kami menyadari sepenuhnya, bahwa website ini masih terus dikembangkan, sehingga masukan dari
                            berbagai pihak sangatlah diharapkan. Tampilan, isi dan mutu website akan terus dikembangkan
                            sehingga akan menjadi lebih baik. Terima kasih atas kerjasamanya. Demikian dan terima kasih.
                        </p>
        ...
        <section id="Strukturorganisasi" class="Strukturorganisasi">
            <div class="container" data-aos="fade-up">
                <div class="col-lg-2 col-md-3 col-4 d-flex align-items-center justify-content-center">
                    <img src="" class="img-fluid" alt="">
                </div>
        ...
        <section id="team" class="team section-bg">
            <div class="container" data-aos="fade-up" style="align-items: center">
                ...
                <div class="section-title">
                    <h2>Divisi</h2>
                    <p>Himpunan Mahasiswa Elektro terbagi menjadi 5 divisi dengan tupoksinya masing masing dan dengan
                        orang-orang yang resilien dibidangnya.</p>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="100">
                        <div class="member d-flex align-items-start">
                            <div class="pic"><img src="assets/img/team/Sait.jpg" class="img-fluid"
                                    alt=""></div>
                    ...
                    <div class="col-lg-6 mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="200">
                        <div class="member d-flex align-items-start">
                            <div class="pic"><img src="assets/img/team/Edos.jpg" class="img-fluid"
                                    alt=""></div>
                            <div class="member-info">
                                <h4>Muhammad Ridho Sofani</h4>
                    ...
                    <div class="col-lg-6 mt-4" data-aos="zoom-in" data-aos-delay="300">
                        <div class="member d-flex align-items-start">
                            <div class="pic"><img src="assets/img/team/Agung.jpg" class="img-fluid"
                                    alt=""></div>
                            <div class="member-info">
                                <h4>Agung Noor Arifin</h4>
                    ...
                    <div class="col-lg-6 mt-4" data-aos="zoom-in" data-aos-delay="400">
                        <div class="member d-flex align-items-start">
                            <div class="pic"><img src="assets/img/team/Firda.jpg" class="img-fluid"
                                    alt=""></div>
                            <div class="member-info">
                                <h4>Firda Widya Dana</h4>
                    ...
                    <div class="row align-center justify-content-center">
                        <div class="col-lg-6 mt-4" data-aos="zoom-in" data-aos-delay="400">
                            <div class="member d-flex align-items-start">
                                <div class="pic"><img src="assets/img/team/Luqman.jpg" class="img-fluid"
                                        alt=""></div>
                                <div class="member-info">
                                    <h4>Muhammad Luqman Azwar Siregar</h4>
            ...
            <div class="container" data-aos="zoom-in">
                <div class="row">
                    <div class="col-lg-9">
                        <h3>Profile Video</h3>
                        <p>
                            Video profil HME memperkenalkan kepada kalian hal-hal berkaitan dengan profile pengurus
                            Himpunan Mahasiswa Elektro.

                            Biar kalian tidak penasaran siapa saja yang ada di dalam Himpunan Mahasiswa Elektro, segera
                            tonton video profilenya.
                        </p>
                    </div>
                    <div class="col-lg-3 text-center">
                        <a href="https://www.youtube.com/watch?v=3e7gNnnQo2g"
                            class="cta-btn align-middle glightbox btn-watch-video">
